...
function cornerwall_dialog(dialog, general_data)
	local specific_data = general_data.cabinet_list[#general_data.cabinet_list]
...
function recreate_cornerwall_solo(general_data, specific_data)
...
function recreate_cornerwall(general_data, specific_data)
	...
	--Right side
	loc_origin[1] = specific_data.corner_width_top - general_data.depth_wall
	loc_origin[2] = general_data.depth_wall - specific_data.width2_top
	...
	poly_array = {{general_data.thickness, 0, 0}, 
					{specific_data.corner_width_top - general_data.depth_wall, 0, 0}, 
					{specific_data.corner_width_top - general_data.depth_wall, general_data.depth_wall - specific_data.width2_top + general_data.thickness, 0}, 
					{specific_data.corner_width_top - groove_dist_back_off, general_data.depth_wall - specific_data.width2_top + general_data.thickness, 0}, 
					{specific_data.corner_width_top - groove_dist_back_off, general_data.depth_wall - groove_dist_back_off, 0},
	...
	poly_array = {{general_data.thickness, general_data.setback_shelves, 0}, 
					{specific_data.corner_width_top - general_data.depth_wall + general_data.setback_shelves, general_data.setback_shelves, 0}, 
					{specific_data.corner_width_top - general_data.depth_wall + general_data.setback_shelves, general_data.depth_wall - specific_data.width2_top + general_data.thickness + general_data.setback_shelves, 0}, 
					{specific_data.corner_width_top - groove_dist_back_off, general_data.depth_wall - specific_data.width2_top + general_data.thickness + general_data.setback_shelves, 0}, 
					{specific_data.corner_width_top - groove_dist_back_off, general_data.depth_wall - groove_dist_back_off, 0},
					{general_data.thickness, general_data.depth_wall - groove_dist_back_off, 0}}
	fla_handle = pytha.create_polygon(poly_array)
	...
	loc_origin[3] = base_height
	new_elem = pytha.create_block(specific_data.corner_width_top - general_data.thickness + general_data.groove_depth - groove_dist_back_off, general_data.thickness_back, door_height, loc_origin, {name = pyloc "Back"})
	table.insert(specific_data.cur_elements, new_elem)
	loc_origin[1] = specific_data.corner_width_top - groove_dist_back_off
	loc_origin[2] = general_data.depth_wall - specific_data.width2_top +  general_data.thickness - general_data.groove_depth
	loc_origin[3] = base_height 
	new_elem = pytha.create_block(general_data.thickness_back, specific_data.width2_top - general_data.thickness + general_data.groove_depth - groove_dist_back_off + general_data.thickness_back, door_height, loc_origin, {name = pyloc "Back"})
	table.insert(specific_data.cur_elements, new_elem)
	
	
	--Door
	local door_width_left = specific_data.corner_width_top - general_data.depth_wall - general_data.thickness - 2 * general_data.gap
	local door_width_right = specific_data.width2_top - general_data.depth_wall - 2 * general_data.gap
	local door_name = {name = pyloc "Door RH"}
	if specific_data.door_rh == false then
		door_width_left = specific_data.corner_width_top - general_data.depth_wall - 2 * general_data.gap
		door_width_right = specific_data.width2_top - general_data.depth_wall - general_data.thickness - 2 * general_data.gap
	...
	if door_width_right > 0 then 
		...
		loc_origin[1] = specific_data.corner_width_top - general_data.depth_wall - general_data.thickness
		if specific_data.door_rh == false then
			loc_origin[2] = general_data.depth_wall - specific_data.width2_top - general_data.gap - general_data.thickness
		else
			loc_origin[2] = general_data.depth_wall - specific_data.width2_top - general_data.gap
		end
		loc_origin[3] = base_height
	...
	local total_door_group = pytha.create_group({door_group1, door_group2}, {name = pyloc "Test"})
	...
	specific_data.main_group = pytha.create_group(specific_data.cur_elements, {name = pyloc "Corner wall cabinet"})
