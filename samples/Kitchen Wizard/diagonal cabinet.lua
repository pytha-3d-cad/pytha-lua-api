...
function diagonal_dialog(dialog, general_data)
	local specific_data = general_data.cabinet_list[#general_data.cabinet_list]
	...
	bt_thick:set_on_change_handler(function(text)
		general_data.benchtop_thickness = pyui.parse_length(text)
		recreate_diagonal_solo(general_data, specific_data)
	end)
	
	width:set_on_change_handler(function(text)
		specific_data.corner_width = pyui.parse_length(text)
		recreate_diagonal_solo(general_data, specific_data)
	end)
	
	width2:set_on_change_handler(function(text)
		specific_data.width2 = pyui.parse_length(text)
		recreate_diagonal_solo(general_data, specific_data)
	end)
...
function recreate_diagonal_solo(general_data, specific_data)
	update_diagonal_ui(general_data, specific_data)
...
function update_diagonal_ui(general_data, specific_data)
...
function recreate_diagonal(general_data, specific_data)
	...
	local slope = (specific_data.width2 - general_data.depth - general_data.thickness - general_data.gap)/(specific_data.corner_width - general_data.depth - general_data.thickness - general_data.gap)
	...
	--Right side
	poly_array = {{specific_data.corner_width, general_data.depth - specific_data.width2 + general_data.thickness, 0}, 
					{specific_data.corner_width - general_data.depth - general_data.thickness / slope + door_diag_offset_x2, general_data.depth - specific_data.width2 + general_data.thickness, 0}, 
					{specific_data.corner_width - general_data.depth + door_diag_offset_x2, general_data.depth - specific_data.width2, 0}, 
					{specific_data.corner_width, general_data.depth - specific_data.width2, 0}}
	...
	poly_array = {{general_data.thickness, -general_data.thickness * slope + door_diag_offset_y1, 0}, 
					{specific_data.corner_width - general_data.depth - general_data.thickness / slope + door_diag_offset_x2, general_data.depth - specific_data.width2 + general_data.thickness, 0}, 
					{specific_data.corner_width - groove_dist_back_off, general_data.depth - specific_data.width2 + general_data.thickness, 0}, 
					{specific_data.corner_width - groove_dist_back_off, general_data.depth - groove_dist_back_off, 0},
	...
	poly_array = {{general_data.thickness, - general_data.thickness * slope + door_diag_offset_y1 + general_data.setback_shelves * PYTHAGORAS(slope, 1), 0}, 
					{specific_data.corner_width - general_data.depth - general_data.thickness / slope + door_diag_offset_x2 + general_data.setback_shelves * PYTHAGORAS(1 / slope, 1), general_data.depth - specific_data.width2 + general_data.thickness, 0}, 
					{specific_data.corner_width - groove_dist_back_off, general_data.depth - specific_data.width2 + general_data.thickness, 0}, 
					{specific_data.corner_width - groove_dist_back_off, general_data.depth - groove_dist_back_off, 0},
					{general_data.thickness, general_data.depth - groove_dist_back_off, 0}}
	fla_handle = pytha.create_polygon(poly_array)
	...
	loc_origin[3] = base_height
	new_elem = pytha.create_block(specific_data.corner_width - general_data.thickness + general_data.groove_depth - groove_dist_back_off, general_data.thickness_back, specific_data.height, loc_origin, {name = pyloc "Back"})
	table.insert(specific_data.cur_elements, new_elem)
	loc_origin[1] = specific_data.corner_width - groove_dist_back_off
	...
	local main_dir = {specific_data.corner_width - general_data.depth - general_data.thickness - general_data.gap, general_data.depth + general_data.thickness + general_data.gap - specific_data.width2, 0}
	...
	local p_out_2 = {specific_data.corner_width - general_data.depth + general_data.kickboard_setback, 
	...
	local p_in_1 = {general_data.gap + (front_setback + general_data.kickboard_thickness) * TAN(90 - miter_angle1), 
					...
					general_data.kickboard_margin}
	local p_in_2 = {specific_data.corner_width - general_data.depth + general_data.kickboard_setback + general_data.kickboard_thickness, 
	...
	poly_array = {{specific_data.corner_width - general_data.depth + general_data.kickboard_setback, general_data.depth - specific_data.width2, general_data.kickboard_margin}, 
					{specific_data.corner_width - general_data.depth + general_data.kickboard_setback + general_data.kickboard_thickness, general_data.depth - specific_data.width2, general_data.kickboard_margin}, p_in_2 , p_out_2}
	fla_handle = pytha.create_polygon(poly_array)
	...
	specific_data.right_connection_point = {specific_data.corner_width, general_data.depth - specific_data.width2, 0}
	specific_data.left_connection_point = {0,general_data.depth,0}
	specific_data.right_direction = -90
	specific_data.left_direction = 0
	
	specific_data.main_group = pytha.create_group(specific_data.cur_elements, {name = pyloc "Diagonal cabinet"})
	
	local z = general_data.benchtop_height - general_data.benchtop_thickness
	poly_array = {{0, -general_data.top_over,z}, 
						{specific_data.corner_width - general_data.depth - general_data.top_over, general_data.depth - specific_data.width2, z}, 
						{specific_data.corner_width, general_data.depth - specific_data.width2, z}, 
...
function get_diag_door_length(general_data, specific_data)
	local p2 = {specific_data.corner_width - general_data.depth - general_data.thickness, general_data.depth - specific_data.width2 + general_data.gap, 0}
