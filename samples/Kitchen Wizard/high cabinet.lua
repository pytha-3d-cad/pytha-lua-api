...
function high_cabinet_solo_dialog(dialog, general_data)
	local specific_data = general_data.cabinet_list[#general_data.cabinet_list]
...
function recreate_high_cabinet_solo(general_data, specific_data)
	update_high_cabinet_solo_ui(general_data, specific_data)
...
function update_high_cabinet_solo_ui(general_data, specific_data)
...
function recreate_high(general_data, specific_data)
	...
	specific_data.main_group = pytha.create_group(specific_data.cur_elements, {name = pyloc "High cabinet"})
