...
function wizard_dialog(dialog, data)
	...
	controls.width:set_on_change_handler(function(text)
		if data.cabinet_list[data.current_cabinet].this_type == "corner" or data.cabinet_list[data.current_cabinet].this_type == "diagonal" then 
			data.cabinet_list[data.current_cabinet].corner_width = math.max(pyui.parse_length(text) or data.cabinet_list[data.current_cabinet].corner_width, 0)
		elseif data.cabinet_list[data.current_cabinet].this_type == "cornerwall" then 
			data.cabinet_list[data.current_cabinet].corner_width_top = math.max(pyui.parse_length(text) or data.cabinet_list[data.current_cabinet].corner_width_top, 0)
		else 
	...
	controls.width2:set_on_change_handler(function(text)
		...
		elseif data.cabinet_list[data.current_cabinet].this_type == "cornerwall" then 
			data.cabinet_list[data.current_cabinet].width2_top = math.max(pyui.parse_length(text) or data.cabinet_list[data.current_cabinet].width2_top, 0)
		else 
			data.cabinet_list[data.current_cabinet].width2 = math.max(pyui.parse_length(text) or data.cabinet_list[data.current_cabinet].width2, 0)
		end
		recreate_all(data, true)
